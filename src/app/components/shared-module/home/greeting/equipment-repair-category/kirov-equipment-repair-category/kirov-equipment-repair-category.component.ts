...
@Component({
  selector: 'app-kirov-equipment-repair-category',
  templateUrl: './kirov-equipment-repair-category.component.html',
  styleUrls: ['./kirov-equipment-repair-category.component.css']
})
export class KirovEquipmentRepairCategoryComponent implements OnInit {
